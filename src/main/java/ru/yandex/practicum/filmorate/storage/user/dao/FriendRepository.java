...
public class FriendRepository extends BaseRepository<Friend> implements FriendStorage {
    private static final String ADD_FRIENDSHIP = "INSERT INTO friends (user_id, friend_id, FRIENDSHIP_STATUS) " +
            "VALUES (?, ?, ?)";
    ...
    private static final String FIND_All_FRIENDS_BY_USER_ID= "SELECT * FROM friends WHERE (USER_ID = ? OR FRIEND_ID = ?)";
